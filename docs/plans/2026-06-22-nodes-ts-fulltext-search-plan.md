...
- The `docs/STANDARD.md` update in Task 5 has already been applied and later extended with similarity and snapshot persistence sections.
...
- [ ] **Step 3: Update `docs/STANDARD.md`**

(a) Update the "Known kernel limitations" bullet at `docs/STANDARD.md:46-48`. Replace:
...
(b) Append a TypeScript subsection at the end of the "Full-text search (derived index)" section (after the line `later plan.` at `docs/STANDARD.md:147`):
...
```bash
rtk git add ts/tests/search-parity.test.ts docs/STANDARD.md
